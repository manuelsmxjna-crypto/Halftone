...
- **Flujo simple unificado** con selector Normal/Neón, niveles negro y blanco, control LPI con muestra de punto, cobertura de tinta estimada y vista previa rápida durante el arrastre.
